...
import com.mrhopeyone.repository.GroupRepository;
import com.mrhopeyone.service.dto.GroupDTO;
import com.mrhopeyone.service.mapper.GroupMapper;
...
class GroupResourceIT {
  ...
  void deleteGroup() throws Exception {
    ...
    // Delete the group
    restGroupMockMvc.perform(delete(ENTITY_API_URL_ID, group.getId()).accept(MediaType.APPLICATION_JSON)).andExpect(status().isNoContent());
