...
describe('Document Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call content query and add missing value', () => {
      ...
      const content: IContent = { id: 96259 };
      document.content = content;

      const contentCollection: IContent[] = [{ id: 36768 }];
    ...
    it('Should call Car query and add missing value', () => {
      const document: IDocument = { id: 456 };
      const car: ICar = { id: 14084 };
      document.car = car;

      const carCollection: ICar[] = [{ id: 94182 }];
    ...
    it('Should update editForm', () => {
      const document: IDocument = { id: 456 };
      const content: IContent = { id: 72478 };
      document.content = content;
      const car: ICar = { id: 93099 };
      document.car = car;
